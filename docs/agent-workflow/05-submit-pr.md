...
- 确认目标作品目录中包含可正常打开的 `presentation.pptx`；
...
除已经随作品项目提交的演示 PPT 外，论文 PDF 或链接、修改说明和教师要求的其他材料按 `docs/SUBMISSION.md` 通过指定私有渠道提交。入口未公布时，将其列为待办，不得上传到公开 GitHub。
